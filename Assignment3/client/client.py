...
class Client:
    ...
    def __init__(
        ...
        # maps album name to album contents
        self._albums: t.Dict[str, Album] = {}
    ...
    def put_photo(self, photo_blob: bytes):
        ...
        log = LogEntry(OperationCode.PUT_PHOTO,
                       PutPhotoLogData(photo_id).encode())
    ...
    def _synchronize_friend(self, friend_username: str):
        ...
        for encoded in resp.encoded_friend_log_entries:
            ...
            if log.opcode == OperationCode.PUT_PHOTO.value:
                log_data = PutPhotoLogData.decode(log.data)
                photo_blob = self._fetch_photo(
                    log_data.photo_id, friend_username)
